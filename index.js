...
// const wss = new WebSocket.Server({ port: 6060 }); // Run WebSocket server on port 6060
...
//         if (data.cmd === "send") {
//           var receiverWS = webSockets[data.userid]; // Check if there is a receiver connection
//           if (receiverWS) {
...
//       ws.send("error: Non-JSON data received");
//     }
//   });
